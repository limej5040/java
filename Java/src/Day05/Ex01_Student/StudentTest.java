...
public class StudentTest {
	public static void main(String[] args) {
		...
		System.out.println("학생1 - 중간고사 점수 : " + student.getAverage(100, 85));
		...
		// Student 객체 생성 
				...
				int scores2[] = {100, 80, 90, 70, 75};		// 학생2의 성적
				...
				System.out.println("학생2 - 중간고사 점수 : " + student2.getAverage(100, 85));
				System.out.println("학생2 - 중간고사 점수 : " + student2.getAverage(scores));
