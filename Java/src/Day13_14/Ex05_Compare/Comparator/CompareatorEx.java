...
//		
		// 방법 2
		int result = age1 - age2;					// 정렬기준1 나이순 오름차순
		int result2 = name1.compareTo(name2);		// 정렬기준2 이름순 내림차순
...
public class CompareatorEx {
	public static void main(String[] args) {
		List<User> userList = Arrays.asList(
				new User("Joeun1004","홍조은", 34),
				new User("user1004","전조은", 25),
				new User("joeun1234","김조은", 33),
				new User("tje10924","배조은", 32),
				new User("aloha1001","황조은", 31),
				new User("hana0315","박조은", 22),
				new User("kje1111","권조은", 15),
				new User("leejoeun22","이조은", 11)
			);
