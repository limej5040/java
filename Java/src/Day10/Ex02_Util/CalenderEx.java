...
public class CalenderEx {
	...
	public static void main(String[] args) {
		...
		// new Calender() 대신, getInstance() 메소드로 객체를 사용한다 
		...
		printCalender ("자바 마지막 수업일(연/월/일)" ,test);
		...
		// 내가 태어난지 몇일이 되었는지 구해보기
		Calendar birth = Calendar.getInstance();
		birth.set(1995, Calendar.JUNE, 19);			// 내 생일로 날짜 지정하기 : 1995 / 06 / 19
		long birthD = birth.getTimeInMillis() / (1000 * 60 * 60 * 24);		// 내 생일로 ms로 반환하고 일 단위로 환산하기
