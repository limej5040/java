...
public class DateEx {
	...
	public static void main(String[] args) throws ParseException {
		...
		String day1 = "2024/08/05";
		String day2 = "2025/02/10";
		...
		// Date.getTime()
		// : 1970년 1월 1일 0시 0분 0초부터 Date에 지정된 날짜/시간 까지의 ms(밀리초) 누적값
		long gapDays = (date2.getTime() - date1.getTime()) / (1000*60*60*24);
		long gapHours = (date2.getTime() - date1.getTime()) / (1000*60*24);
		...
		// * Date 객체의 getxxx() 메소드는 deprecated(더이상 사용권장안함)
		//--> 날짜의 년/월/일 추출하는 기능은 Calendar클래스를 주로 사용
