...
public class _05_Stream {
	...
	String[] langs = {"phthon", "java", "javascript", "c", "c++", "c#"};
	Stream<String> stream = Arrays.stream(langs);
	
	
	// Collection.steam()
	List<String> langList = new ArrayList<>();
	langList = Arrays.asList("phthon", "java", "javascript", "c", "c++", "c#");
	...
	// Stream.of ()
	Stream<String> langListOfStream = Stream.of("phthon", "java", "javascript", "c", "c++", "c#");
...
//	Arrays.stream(scores).filter(x -> x >= 90).forEach(System.out::println);
	...
	// 3글자 이하의 언어들은 모두 c 라는 글자를 포함하는 지 여부
